...
data_2 = cleaned_data[cleaned_data.iloc[:,78] == 1]
data_3 = cleaned_data[cleaned_data.iloc[:,78] == 2]
data_4 = cleaned_data[cleaned_data.iloc[:,78] == 3]
data_5 = cleaned_data[cleaned_data.iloc[:,78] == 4]

# Data Augmentation
from sklearn.utils import resample

# Resample Data using Bootstrapping Algorithm
...
plt.pie(train_dataset.iloc[:,78].value_counts(), labels=['Benign', 'DoS-Hulk', 'DoS-GoldenEye', 'FTP-Patator', 'SSH-Patator'], colors=['orange', 'green', 'blue', 'magenta', 'cyan'])
p = plt.gcf()
...
def model_train(model, X_train, y_train, X_test, y_test):
    ...
    model.save("saved_models/cnn_model_baseline_ids2017_combined.h5")
...
my_dict = {0:'0-Benign',  1:'1-DoS-Hulk', 2:'2-DoS-GoldenEye', 3:'3-FTP-Patator', 4:'4-SSH-Patator'}
