...
# 1-Dos-SLowloris
data_2 = cleaned_data[cleaned_data['Label'] == 4]
# 2-Dos-GoldenEye
data_3 = cleaned_data[cleaned_data['Label'] == 3]
# 3-BruteForce-FTP
data_4 = cleaned_data[cleaned_data['Label'] == 1]
# 4-BruteForce-SSH
data_5 = cleaned_data[cleaned_data['Label'] == 2]
...
plt.pie(train_dataset['Label'].value_counts(), labels=['0-Benign', '4-Dos-Slowloris', '3-Dos-GoldenEye', '1-FTP-BruteForce', '2-SSH-BruteForce'], colors=['orange', 'green', 'blue', 'magenta', 'cyan'])
p = plt.gcf()
...
if(train_model == 1):
    ...
    for layer in model.layers[10:13]:
    ...
    # freeze_top_layers
    model.save("saved_models/ids2017c_tf_ids2018c_s2_fz_cxl.h5")
    ...
    # Load Trained Model
    print("\nLoading Trained Model")
    model = load_model("saved_models/ids2017c_tf_ids2018c_s2_fz_cxl.h5")
    model.summary()
...
my_dict = {0:'0-Benign', 1:'1-Dos-Slowloris', 2:'2-Dos-GoldenEye', 3:'3-FTP-BruteForce', 4:'4-SSH-BruteForce'}
